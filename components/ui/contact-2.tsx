        ...
        <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-20">
          ...
          <div className="flex flex-col justify-between gap-10 max-w-md mx-auto lg:mx-0">
            <div className="text-center lg:text-left">
              <h1 className="mb-3 text-4xl md:text-5xl font-semibold text-black">
                {title}
              </h1>
            ...
            {(phone || email) && (
              <div className="mx-auto lg:mx-0">
                <h3 className="mb-6 text-center lg:text-left text-xl font-semibold text-black">
                  Contact Details
                </h3>
                <ul className="space-y-4">
                  {phone && (
                    <li className="flex items-center gap-3">
                      ...
                      <div>
                        <span className="text-xs text-black/50 uppercase tracking-wide">Phone</span>
                  ...
                  {email && (
                    <li className="flex items-center gap-3">
                      ...
                      <div>
                        <span className="text-xs text-black/50 uppercase tracking-wide">Email</span>
                        <a href={`mailto:${email}`} className="block text-black font-medium hover:text-primary transition-colors">
                          {email}
                        </a>
                      </div>
                    </li>
          ...
          <div className="flex-1 max-w-xl mx-auto lg:mx-0">
            {status === "success" ? (
              <div className="flex flex-col items-center justify-center gap-3 rounded-xl border border-border bg-white/60 backdrop-blur-sm p-8 shadow-sm text-center">
                <CheckCircle className="w-10 h-10 text-primary" />
                <h3 className="text-lg font-semibold text-black">Message sent!</h3>
                <p className="text-sm text-black/70">Thanks for reaching out — we&apos;ll get back to you soon.</p>
                <button
                  type="button"
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5 rounded-xl border border-border bg-white/60 backdrop-blur-sm p-8 shadow-sm">
                {status === "error" && (
